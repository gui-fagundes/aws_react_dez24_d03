    ...
    <div className="flex flex-col flex-nowrap gap-3">
      <div className="flex flex-col md:flex-row justify-around bg-w-100 flex-nowrap mt-32 items-center">
        ...
        <div className="bg-[url-(/src/assets/Hero-elipse.png)]  invisible md:visible">
          <img src="/src/assets/Hero-Image.png" alt="" className="h-[255px]" />
        </div>
      </div>
      <div className="flex flex-col md:flex-row bg-w-900 justify-center px-15 items-center gap-4 py-20">
        <div className="max-h-[266px] max-w-82 px-10 flex flex-col gap-3">
          ...
          <h1 className="text-H5 text-bl-800 font-semibold font-inter">Free Shipping</h1>
        ...
        <div className="max-h-[266px] max-w-82 px-10 flex flex-col gap-3">
          ...
          <h1 className="text-H5 text-bl-800 font-semibold font-inter">Satisfaction Guarantee</h1>
          <p className="text-P1 text-bl-500 font-normal">
        ...
        <div className="max-h-[266px] max-w-82 px-10 flex flex-col gap-3">
          ...
          <h1 className="text-H5 text-bl-800 font-semibold font-inter">Secure Payment</h1>
          <p className="text-P1 text-bl-500 font-normal">
      ...
      <div className="flex flex-col gap-4 mt-10 items-center px-25">
            ...
            <h1 className="font-inter text-H3 text-bl-900 font-bold">Best Selling</h1>
            <Cards />
      </div>
      <div className="flex flex-col md:flex-row justify-around bg-w-100 flex-nowrap mt-32 items-center">
        <div className="flex flex-col justify-center gap-10">
        ...
        <div className="bg-[url-(/src/assets/Hero-elipse.png)]  invisible md:visible">
          <img src="/src/assets/CategoryImage.png" alt="" className="h-[255px]" />
        </div>
      </div>
      <div className="flex flex-col gap-4 mt-10 items-center px-25">
